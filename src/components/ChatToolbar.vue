...
interface IEmits {
  (event:'clickProfile'):void;
  (event:'clickAppearance'):void;
}
defineProps<IProps>();
defineEmits<IEmits>();
...
<template>
    ...
    >
      <button 
        ...
        id="login" 
        class="hover:ring-1 ring-slate-100 rounded-md p-1"
      >
        <svg 
          width="25px" 
          height="25px" 
      ...
      <div class="relative inline-block text-left">
          ...
          <svg 
            ...
            <g id="SVGRepo_iconCarrier"> 
              <path 
                fill-rule="evenodd" 
                clip-rule="evenodd" 
                d="M14.1395 12.0002C14.1395 13.1048 13.2664 14.0002 12.1895 14.0002C11.1125 14.0002 10.2395 13.1048 10.2395 12.0002C10.2395 10.8957 11.1125 10.0002 12.1895 10.0002C13.2664 10.0002 14.1395 10.8957 14.1395 12.0002Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M7.57381 18.1003L5.12169 12.8133C4.79277 12.2907 4.79277 11.6189 5.12169 11.0963L7.55821 5.89229C7.93118 5.32445 8.55898 4.98876 9.22644 5.00029H12.1895H15.1525C15.8199 4.98876 16.4477 5.32445 16.8207 5.89229L19.2524 11.0923C19.5813 11.6149 19.5813 12.2867 19.2524 12.8093L16.8051 18.1003C16.4324 18.674 15.8002 19.0133 15.1281 19.0003H9.24984C8.5781 19.013 7.94636 18.6737 7.57381 18.1003Z" 
                stroke="#ffffff" 
                stroke-width="1.5" 
                stroke-linecap="round" 
        ...
        <transition>
          <div id="dropdown-content" v-if="showOptions" class=" absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg p-2">
              <div 
                @click="()=>{
                  showOptions = false;
                  $emit('clickAppearance')
                }" 
                class="flex items-center px-4 py-2 text-gray-800 hover:bg-gray-200 rounded-md font-semibold"
              >
                <svg 
                  width="20px" 
                  height="20px" 
                  ...
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier"> 
                    <path d="M9 21H12M15 21H12M12 21V18M12 18H19C20.1046 18 21 17.1046 21 16V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V16C3 17.1046 3.89543 18 5 18H12Z" 
                      stroke="#000000" 
                      stroke-width="2" 
                      stroke-linecap="round" 
                      stroke-linejoin="round">
              ...
              <!-- <div class="flex items-center px-4 py-2 text-gray-800 hover:bg-gray-200 rounded-md">
