...
const hideOptions = ref<boolean>(true)
</script>
<template>
    <div class="bg-blue-500 p-4 text-white flex justify-between items-center">
      ...
      <div class="relative inline-block text-left">
        <button @click="hideOptions = !hideOptions" class="hover:bg-blue-400 rounded-md p-1">
        ...
        <transition>
          <div id="dropdown-content" v-if="hideOptions" class=" absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg p-2">
